          ...
          <div className="fourth_second">
            <div className="contce-AboutFourth">
              ...
              <div className="AboutFourthContext">
                <p>
                  ...
                  laboriosam, nulla, id quod consequatur, vitae voluptatem
                  soluta eligendi. Fugiat nostrum voluptatem ab quisquam.
                </p>
              </div>
              <br />
              <br />
            ...
            <div className="aboutVisionBlock">
              <AboutOurPeople
                heading="Our People"
                context=" 
    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Doloremque laboriosam, aperiam vero amet, obcaecati magnam eum facilis alias, numquam veritatis officia. Corporis velit fugiat soluta reprehenderit laboriosam veniam mollitia distinctio.
    "
                img={image}
                heading2="Our People"
                context2=" 
